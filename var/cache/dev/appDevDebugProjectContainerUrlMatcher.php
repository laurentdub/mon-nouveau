...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // app_hello_hello
        if ($pathinfo === '/Hello') {
            return array (  '_controller' => 'AppBundle\\Controller\\Hello::helloAction',  '_route' => 'app_hello_hello',);
        }

        // hello
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)(?:/(?P<surname>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'hello')), array (  'surname' => 'noone',  '_controller' => 'AppBundle\\Controller\\HelloController::indexAction',));
        }
